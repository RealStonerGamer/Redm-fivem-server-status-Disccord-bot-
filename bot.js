...
exports.start = function(SETUP) {
  ...
  const UpdateEmbed = function() {
    ...
    .setAuthor("Forgotten trails RP ", "https://i.imgur.com/Z16zOou.png")
    .setColor(0x2894C2)
    .setFooter(TICK_N % 2 === 0 ? '⚪ Forgotten Trails RP' : '⚫ Forgotten Trails RP ')
    .setTimestamp(new Date())
    .addField('\n\u200b\nHow can you join the server?','You can join the server by entering ** connect cfx.re/join/apkkkz ** IN F8 console . At the bottom is the server status to see how many people are online . This system was created by [Stoner](https://github.com/RealStonerGamer)\n\u200b\n',false)
    if (STATUS !== undefined)
    {
  ...
  const updateMessage = function() {
    ...
    // method C
           ...
           embed.addField('Online Players',playerNames,false);
         ...
         //  let maxLen = 8;
          // var text = '';
           //for (var i=0;i<players.length;i++) {
             ...
             //if (eol) text += '\n';
           //}
          // embed.addField('players',`**${text}**`,false);
       ...
       //   embed.addField('Spelers','\u200b',false);
        //   for (var player of players) {
          ...
          // }
          // for (var i=0;i<1-(players.length%3);i++) {
  ...
  bot.on('ready',() => {
    ...
    //bot.user.setGame('Forgoten Trails RP', 'https://discord.gg/forgottentrails');
    bot.user.setActivity('Forgoten Trails RP ',{'url':'https://discord.gg/forgottentrails','type':'Playing ON'});
